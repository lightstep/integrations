...
resource "lightstep_dashboard" "azure_dbforpostgresql_serversv2_overview" {
  project_name          = var.lightstep_project
  dashboard_name        = "DB For PostgreSQL Servers V2 Metrics"
  dashboard_description = "[Beta] Monitor DB For PostgreSQL Servers V2 with this metrics overview dashboard."
