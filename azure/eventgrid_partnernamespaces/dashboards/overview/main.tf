...
output "dashboard_url" {
  value       = "https://app.lightstep.com/${var.lightstep_project}/dashboard/${lightstep_dashboard.azure_eventgrid_partnernamespaces_overview.id}"
  description = "OpenTelemetry Collector Event Grid Partner Namespaces Dashboard URL"
}

resource "lightstep_dashboard" "azure_eventgrid_partnernamespaces_overview" {
  project_name          = var.lightstep_project
  dashboard_name        = "Event Grid Partner Namespaces Metrics"
  dashboard_description = "[Beta] Monitor Event Grid Partner Namespaces with this metrics overview dashboard."
