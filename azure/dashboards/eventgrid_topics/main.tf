...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventgrid_topics Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventgrid_topics Metrics"
  dashboard_description = "Monitor Eventgrid_topics with this metrics overview dashboard."
