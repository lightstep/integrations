...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Cloudtest_hostedpools Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Cloudtest_hostedpools Metrics"
  dashboard_description = "Monitor Cloudtest_hostedpools with this metrics overview dashboard."
