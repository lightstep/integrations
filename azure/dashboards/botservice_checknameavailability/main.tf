...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Botservice_checknameavailability Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Botservice_checknameavailability Metrics"
  dashboard_description = "Monitor Botservice_checknameavailability with this metrics overview dashboard."
