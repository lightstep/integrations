...
---
Once you've integrated with [Azure Monitor](/docs/setup-azure-for-metrics), you have access to all metrics for Microsoft.DBforMySQL/servers, **PUT DESCRIPTION HERE**. 
