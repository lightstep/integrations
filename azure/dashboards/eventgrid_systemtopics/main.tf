...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventgrid_systemtopics Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventgrid_systemtopics Metrics"
  dashboard_description = "Monitor Eventgrid_systemtopics with this metrics overview dashboard."
...
EOT
  ...
  chart {
    name = "azure_serverdeliverysuccessrate_total"
    rank = "10"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_unmatchedeventcount_total"
    rank = "11"
    type = "timeseries"
