...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Botservice_listqnamakerendpointkeys Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Botservice_listqnamakerendpointkeys Metrics"
  dashboard_description = "Monitor Botservice_listqnamakerendpointkeys with this metrics overview dashboard."
