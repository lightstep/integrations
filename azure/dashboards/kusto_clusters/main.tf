...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Kusto_clusters Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Kusto_clusters Metrics"
  dashboard_description = "Monitor Kusto_clusters with this metrics overview dashboard."
