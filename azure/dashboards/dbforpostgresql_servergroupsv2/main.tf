...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Dbforpostgresql_servergroupsv2 Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Dbforpostgresql_servergroupsv2 Metrics"
  dashboard_description = "Monitor Dbforpostgresql_servergroupsv2 with this metrics overview dashboard."
...
EOT
  ...
  chart {
    name = "azure_apps_reserved_memory_percent_average"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_vm_cached_bandwidth_percent_average"
    rank = "12"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_vm_cached_iops_percent_average"
    rank = "13"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_vm_uncached_bandwidth_percent_average"
    rank = "14"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_vm_uncached_iops_percent_average"
    rank = "15"
    type = "timeseries"
