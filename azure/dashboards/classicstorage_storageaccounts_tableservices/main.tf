...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Classicstorage_storageaccounts_tableservices Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Classicstorage_storageaccounts_tableservices Metrics"
  dashboard_description = "Monitor Classicstorage_storageaccounts_tableservices with this metrics overview dashboard."
