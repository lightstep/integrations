...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Botservice_hostsettings Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Botservice_hostsettings Metrics"
  dashboard_description = "Monitor Botservice_hostsettings with this metrics overview dashboard."
