...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Keyvault_vaults Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Keyvault_vaults Metrics"
  dashboard_description = "Monitor Keyvault_vaults with this metrics overview dashboard."
...
EOT
  ...
  chart {
    name = "azure_saturationshoebox_average"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_serviceapiresult_count"
    rank = "4"
    type = "timeseries"
