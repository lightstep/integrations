...
resource "lightstep_dashboard" "otel_collector_dashboard" {
  ...
  dashboard_name = "Compute_disks Metrics"
  dashboard_description = "Monitor Compute_disks with this metrics overview dashboard."

  chart {
    name = "azure_composite_disk_read_bytes/sec_average"
    rank = "0"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_composite_disk_read_operations/sec_average"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_composite_disk_write_bytes/sec_average"
    rank = "2"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_composite_disk_write_operations/sec_average"
    rank = "3"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_diskpaidburstiops_average"
    rank = "4"
    type = "timeseries"
