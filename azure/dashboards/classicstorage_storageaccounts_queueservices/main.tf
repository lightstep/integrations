...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Classicstorage_storageaccounts_queueservices Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Classicstorage_storageaccounts_queueservices Metrics"
  dashboard_description = "Monitor Classicstorage_storageaccounts_queueservices with this metrics overview dashboard."
...
EOT
  ...
  chart {
    name = "azure_queuecapacity_average"
    rank = "3"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_queuemessagecount_average"
    rank = "5"
    type = "timeseries"
