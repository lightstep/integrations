...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Storage_storageaccounts_queueservices Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Storage_storageaccounts_queueservices Metrics"
  dashboard_description = "Monitor Storage_storageaccounts_queueservices with this metrics overview dashboard."
