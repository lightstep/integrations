...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Recoveryservices_vaults Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Recoveryservices_vaults Metrics"
  dashboard_description = "Monitor Recoveryservices_vaults with this metrics overview dashboard."
