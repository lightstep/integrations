...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventgrid_extensiontopics Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventgrid_extensiontopics Metrics"
  dashboard_description = "Monitor Eventgrid_extensiontopics with this metrics overview dashboard."
