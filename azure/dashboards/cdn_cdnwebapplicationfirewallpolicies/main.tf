...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Cdn_cdnwebapplicationfirewallpolicies Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Cdn_cdnwebapplicationfirewallpolicies Metrics"
  dashboard_description = "Monitor Cdn_cdnwebapplicationfirewallpolicies with this metrics overview dashboard."
