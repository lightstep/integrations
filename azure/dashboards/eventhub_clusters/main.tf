...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventhub_clusters Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventhub_clusters Metrics"
  dashboard_description = "Monitor Eventhub_clusters with this metrics overview dashboard."

  chart {
    name = "azure_activeconnections_average"
    rank = "0"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_availablememory_maximum"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_capturebacklog_total"
    rank = "2"
    type = "timeseries"
    ...
    query {
      ...
      hidden       = false
      query_string = <<EOT
metric azure_capturebacklog_total | filter (  (azuremonitor.subscription_id == $azuremonitor_subscription_id)   &&  (azuremonitor.tenant_id == $azuremonitor_tenant_id)   &&  (azuremonitor.resource_id == $azuremonitor_resource_id)   &&  (location == $location) )  | delta | group_by [], sum
EOT
    }
  }

  chart {
    name = "azure_capturedbytes_total"
    rank = "3"
    type = "timeseries"
    ...
    query {
      ...
      hidden       = false
      query_string = <<EOT
metric azure_capturedbytes_total | filter (  (azuremonitor.subscription_id == $azuremonitor_subscription_id)   &&  (azuremonitor.tenant_id == $azuremonitor_tenant_id)   &&  (azuremonitor.resource_id == $azuremonitor_resource_id)   &&  (location == $location) )  | delta | group_by [], sum
EOT
    }
  }

  chart {
    name = "azure_capturedmessages_total"
    rank = "4"
    type = "timeseries"
    ...
    query {
      ...
      hidden       = false
      query_string = <<EOT
metric azure_capturedmessages_total | filter (  (azuremonitor.subscription_id == $azuremonitor_subscription_id)   &&  (azuremonitor.tenant_id == $azuremonitor_tenant_id)   &&  (azuremonitor.resource_id == $azuremonitor_resource_id)   &&  (location == $location) )  | delta | group_by [], sum
EOT
    }
  }

  chart {
    name = "azure_connectionsclosed_average"
    rank = "5"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_connectionsopened_average"
    rank = "6"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_incomingbytes_total"
    rank = "8"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_incomingrequests_total"
    rank = "10"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_outgoingbytes_total"
    rank = "11"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_outgoingmessages_total"
    rank = "12"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_quotaexceedederrors_total"
    rank = "13"
    type = "timeseries"
...
EOT
  ...
  chart {
    ...
    query {
      ...
      hidden       = false
      query_string = <<EOT
metric azure_size_average | filter (  (azuremonitor.subscription_id == $azuremonitor_subscription_id)   &&  (azuremonitor.tenant_id == $azuremonitor_tenant_id)   &&  (azuremonitor.resource_id == $azuremonitor_resource_id)   &&  (location == $location)   &&  (metadata_role == $metadata_role) )  | delta | group_by [], sum
EOT
    }
  }
...
EOT
  ...
  chart {
    name = "azure_throttledrequests_total"
    rank = "17"
    type = "timeseries"
