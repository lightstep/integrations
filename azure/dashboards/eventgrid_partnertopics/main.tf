...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventgrid_partnertopics Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventgrid_partnertopics Metrics"
  dashboard_description = "Monitor Eventgrid_partnertopics with this metrics overview dashboard."
