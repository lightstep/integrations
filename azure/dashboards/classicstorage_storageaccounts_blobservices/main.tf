...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Classicstorage_storageaccounts_blobservices Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Classicstorage_storageaccounts_blobservices Metrics"
  dashboard_description = "Monitor Classicstorage_storageaccounts_blobservices with this metrics overview dashboard."
