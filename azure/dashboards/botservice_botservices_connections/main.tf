...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Botservice_botservices_connections Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Botservice_botservices_connections Metrics"
  dashboard_description = "Monitor Botservice_botservices_connections with this metrics overview dashboard."
