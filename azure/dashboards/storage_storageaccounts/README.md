---
title: Azure Microsoft.Storage/storageAccounts metrics
date: 2023-06-29 00:00:00
canonical_url:
description: See the Azure Microsoft.Storage/storageAccounts metrics ingested by Lightstep Observability
...
tags:
  ...
  - Metrics
  - Azure
azure_int: Microsoft.Storage/storageAccounts
authors:
  - otel-team
layout: table
cards:
...
---
Once you've integrated with [Azure Monitor](/docs/setup-azure-for-metrics), you have access to all metrics for Microsoft.Storage/storageAccounts, **PUT DESCRIPTION HERE**. 
...
<colgroup><col span="1" style="width: 35%;" /><col span="1" style="width: 15%;" /><col span="1" style="width: 35%;" /></colgroup>
  ...
  <tr>
    ...
    <td>Bytes</td>
    <td>The amount of storage used by the storage account. For standard storage accounts, it's the sum of capacity used by blob, table, file, and queue. For premium storage accounts and Blob storage accounts, it is the same as BlobCapacity or FileCapacity.</td>
  </tr>
</table>
