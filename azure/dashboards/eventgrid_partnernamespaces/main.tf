...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Eventgrid_partnernamespaces Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Eventgrid_partnernamespaces Metrics"
  dashboard_description = "Monitor Eventgrid_partnernamespaces with this metrics overview dashboard."
