...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Network_azurefirewalls Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Network_azurefirewalls Metrics"
  dashboard_description = "Monitor Network_azurefirewalls with this metrics overview dashboard."

  chart {
    name = "azure_applicationrulehit_total"
    rank = "0"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_dataprocessed_total"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_firewallhealth_average"
    rank = "2"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_firewalllatencypng_average"
    rank = "3"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_networkrulehit_total"
    rank = "4"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_snatportutilization_average"
    rank = "5"
    type = "timeseries"
