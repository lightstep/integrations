...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Storage_storageaccounts_storagetasks Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Storage_storageaccounts_storagetasks Metrics"
  dashboard_description = "Monitor Storage_storageaccounts_storagetasks with this metrics overview dashboard."

  chart {
    name = "azure_objectsoperatedcount_total"
    rank = "0"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_objectsoperationfailedcount_total"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_objectstargetedcount_total"
    rank = "2"
    type = "timeseries"
