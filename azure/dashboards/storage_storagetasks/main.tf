...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Storage_storagetasks Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Storage_storagetasks Metrics"
  dashboard_description = "Monitor Storage_storagetasks with this metrics overview dashboard."
