...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Network_dnszones Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Network_dnszones Metrics"
  dashboard_description = "Monitor Network_dnszones with this metrics overview dashboard."
