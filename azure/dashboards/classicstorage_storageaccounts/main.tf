...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Classicstorage_storageaccounts Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Classicstorage_storageaccounts Metrics"
  dashboard_description = "Monitor Classicstorage_storageaccounts with this metrics overview dashboard."
...
EOT
  ...
  chart {
    name = "azure_usedcapacity_average"
    rank = "6"
    type = "timeseries"
