...
output "dashboard_url" {
  ...
  description = "OpenTelemetry Collector Containerinstance_containergroups Dashboard URL"
}

resource "lightstep_dashboard" "otel_collector_dashboard" {
  project_name   = var.lightstep_project
  dashboard_name = "Containerinstance_containergroups Metrics"
  dashboard_description = "Monitor Containerinstance_containergroups with this metrics overview dashboard."

  chart {
    name = "azure_cpuusage_average"
    rank = "0"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_memoryusage_average"
    rank = "1"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_networkbytesreceivedpersecond_average"
    rank = "2"
    type = "timeseries"
...
EOT
  ...
  chart {
    name = "azure_networkbytestransmittedpersecond_average"
    rank = "3"
    type = "timeseries"
